...
QT_MOC_LITERAL(1, 13, 15), // "NewFrameChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7), // "cv::Mat"
QT_MOC_LITERAL(4, 38, 8), // "rawFrame"
QT_MOC_LITERAL(5, 47, 9) // "OpenVideo"

    },
    "VideoManager\0NewFrameChanged\0\0cv::Mat\0"
    "rawFrame\0OpenVideo"
};
...
void VideoManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->NewFrameChanged((*reinterpret_cast< cv::Mat(*)>(_a[1]))); break;
        case 1: { bool _r = _t->OpenVideo();
        ...
        {
            using _t = void (VideoManager::*)(cv::Mat );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoManager::NewFrameChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoManager::NewFrameChanged(cv::Mat _t1)
{
