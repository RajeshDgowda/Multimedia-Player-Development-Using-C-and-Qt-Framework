...
QT_MOC_LITERAL(5, 41, 12), // "RecieveFrame"
QT_MOC_LITERAL(6, 54, 10), // "RunCapture"
QT_MOC_LITERAL(7, 65, 3) // "url"

    },
    "ThreadManager\0updateFrame\0\0cv::Mat\0"
    "frame\0RecieveFrame\0RunCapture\0url"
};
...
void ThreadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->RecieveFrame((*reinterpret_cast< cv::Mat(*)>(_a[1]))); break;
        case 2: _t->RunCapture((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ThreadManager::*)(cv::Mat );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadManager::updateFrame)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ThreadManager::updateFrame(cv::Mat _t1)
{
